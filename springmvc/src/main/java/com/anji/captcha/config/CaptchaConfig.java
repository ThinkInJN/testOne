...
public class CaptchaConfig {
    ...
    public CaptchaCacheService captchaCacheService() {
        //缓存类型redis/local/....
        return CaptchaServiceFactory.getCache("redis");
    }
...
//        }
        ...
        config.put(Const.CAPTCHA_WATER_MARK, "简设计登录验证");
        config.put(Const.CAPTCHA_FONT_TYPE, "汉仪旗黑-55S");
        ...
        config.put(Const.CAPTCHA_WATER_FONT, "汉仪旗黑-55S");
